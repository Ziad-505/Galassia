	...
	try {
		...
		if (refreshToken) {
			try {
				...
				console.log("Redis unavailable during logout");
...
export const refreshToken = async (req, res) => {
	try {
		...
		// Try to check Redis, but allow refresh if Redis is unavailable
		try {
			...
			console.log("Redis unavailable, skipping token validation");
